  ...
  return (
    <section className="relative bg-[#28400D]">
      ...
      <div className="pt-6 pl-8">
        {/* Section header */}
        <div className="bg-#[#28400D] relative">
          <div className="flex">
            <div className="relative w-3/5 pb-4 space-y-8 ml-14 lg:pt-44 ">
              <h1 className="text-[64px] leading-none text-white">
                Memelihara, Memanen, <br /> & Menyebarkan
              </h1>
              <p className="text-[16px] text-gray-300 lg:w-11/12">
                Punggur Besar merupakan Desa Perkebunan dengan hasil bumi yang
                melimpah yang dimanfaatkan secara mentah maupun dijadikan
                sebagai bahan dasar pembuatan berbagai macam olahan
              </p>
              <p className="text-[#E8BB15]">JELAJAHI DESA</p>
            </div>
            <div className="w-2/5 h-full border-l border-1 mt-14">
              {/* Hero image */}
              <HeroImage />
            </div>
          </div>
