      ...
      <div className="bg-[#F1EAE2]">
        <div className="pb-12 md:pb-20 columns-1">
          <div className="mx-auto text-center pt-16 text-[#7A4631] columns-1 md:columns-2 px-12">
            <h1 className="font-extrabold text-3xl md:pt-4 md:text-[64px] font-[AbrilFatface]">Komoditas Unggulan</h1>
          ...
          <div className="border-b-2 border-[#7A4631] py-8 text-[#7A4631] flex row justify-between">
            <h1 className="pt-[8px] ml-4 py-2 md:ml-16 ">
              ...
              <span className="font-bold ml-4 text-[20px] md:text-[48px]">{item.title}</span>
            </h1>
            <div className="flex mr-10 text-right row">
              <h1 className=" font-bold text-[11px] pt-[15px] text-[#E8BB15] ml-2 sm:text-[15px] sm:pt-[12px] md:pt-[26px] md:text-[20px] lg:pt-[34px] lg:text-[25px]">
                Hubungi Pekebun <span>|</span>
              </h1>
              <img className="ml-4 pt-[10px] sm:pt-[5px] md:pt-[20px] w-[32px] lg:pt-[16px]" src="images/chat.png" alt="/" />
            </div>
          </div>
          ))}
          {/* slider transition */}
