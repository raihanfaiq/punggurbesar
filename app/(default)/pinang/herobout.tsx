      ...
      <div className="w-full px-4 pt-16 py-16">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
          <div className="md:mx-auto">
            <img src={sliderData.value} className="h-[300px] w-[500px] border-2 border-red-700" alt="" />
            <div className="flex pt-4 space-x-4">
              {imgs.map((data, i) => (
                <img key={data.id} src={data.value} onClick={() => handlerClick(i)} className="h-[80px] w-[70px] border-2 border-red-700 " alt="/" />
              ))}
            </div>
          </div>
          <div className="flex flex-col pt-6 justify-center text-center md:ml-8 md:text-center">
            ...
            <h1 className="text-[#7A4631] font-bold text-2xl text-left md:text-3xl sm:text-3xl  font-[AbrilFatFace]">
              Katalog <span className="font-light ml-8">Piring Series</span>
            </h1>
