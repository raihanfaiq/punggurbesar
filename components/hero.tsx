      ...
      {/* <div className="w-full pt-20 pl-4 ml-10">
        <div className="grid md:grid-cols-5">
          ...
          <div className="flex flex-col justify-center col-span-3 py-12 text-center md:ml-8 md:text-left">
            <h1 className="text-[#F1EAE2] font-bold text-2xl mr-[80px] md:text-[64px] sm:text-3xl pt-10 font-[AbrilFatFace] leading-tight">
              Memelihara, Memanen, <br /> & Menyebarkan
            </h1>
            <h4 className="text-[#F1EAE2] text-[16px] w-3/4 font-[JosefinSans] pb-10 pt-4 sm:text-center">
            ...
            <div className="flex pt-2 mx-auto md:mx-0">
              <h3 className="text-[#E8BB15] font-[AbrilFatface] text-[24px]">Jelajahi Desa</h3>
