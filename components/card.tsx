...
//   return (
//     <section>
//       <div className="card m-2 border-2 border-red-600  bg-[#F1EAE2] w-[200px] h-[320px] shadow-lg">
//         <div className="top">
//           <img className="w-[200px] h-[200px] object-cover p-2" src={props.image} alt="" />
//         </div>

//         <div className="bottom flex flex-col justify-center items-start p-3">
//           <div id="title" className="title font-bold my-1">
//             {props.title}
//           </div>
//           <div className="paragraph text-xs font-light my-1">{props.detail}</div>
