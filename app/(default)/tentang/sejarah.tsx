...
export default function Sejarah() {
  return (
    <section className="relative bg-[#28400D] pt-12 pl-20 pr-4">
        ...
        <div className="max-w-[1240px] mx-auto grid lg:grid-cols-3">
          ...
          <div className="flex flex-col justify-center text-center md:ml-8 md:text-center">
            <h4 className="text-[#F1EAE2] ">
              ...
              cupiditate dolores, quam similique sapiente labore ipsam
              necessitatibus, maxime dignissimos odio natus error rerum ratione.
              Tenetur error quaerat dolore exercitationem?
            </h4>
          </div>
          <div className="flex flex-col justify-center text-center md:ml-8 md:text-center">
            <h4 className="text-[#F1EAE2] ">
            ...
            <div className="flex pt-12 mx-auto lg:pt-6">
              <h3 className="text-[#E8BB15]">Pelajari Lebih Lanjut</h3>
